...
def push_up(image, pose,count_left, count_right,count_push_up,stage_left,stage_right,stage_push_up):
    # Recolor Image
    ...
    cv2.putText(image, f"Push-Up Count: {count_push_up}", (10, 110), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2,
                cv2.LINE_AA)
    ...
    return image,count_left, count_right,count_push_up,stage_left,stage_right,stage_push_up