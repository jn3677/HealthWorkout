...
def curl_ups(image, pose, count_left, count_right, stage_left, stage_right):
    # Recolor Image
    ...
    try:
        ...
        pass
    cv2.putText(image, "Curls", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2,
                cv2.LINE_AA)
    cv2.putText(image, f"Left Hand Count: {count_left}", (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2,
                cv2.LINE_AA)
    cv2.putText(image, f"Right Hand Count: {count_right}", (10, 110), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2,
                cv2.LINE_AA)
    ...
    return image, count_left, count_right, stage_left, stage_right
